...
export const handleAuthError = (error: AuthError): string => {
  const errorMessages: Record<string, string> = {
    ...
    "auth/invalid-disabled-field":
      "The disabled user property must be a boolean.",
    "auth/invalid-display-name": "The display name must be a non-empty string.",
    "auth/invalid-email-verified":
      "The email verified property must be a boolean.",
    "auth/invalid-email": "The email address is invalid.",
    "auth/invalid-password":
      "The password must be a string with at least 6 characters.",
    "auth/invalid-phone-number":
      "The phone number is invalid. It must be a non-empty E.164 standard compliant identifier string.",
    "auth/invalid-photo-url": "The photo URL must be a string URL.",
    "auth/invalid-uid":
      "The provided user ID is invalid. It must be a non-empty string with at most 128 characters.",
    ...
    "auth/uid-already-exists":
      "The provided user ID is already in use by an existing user.",
    "auth/user-not-found":
      "There is no user record corresponding to the provided identifier.",
    "auth/weak-password": "The password must be at least 6 characters long.",
    "auth/invalid-credential":
      "The provided credential are invalid. Please check Email and Password.",
    ...
    "auth/unauthorized-domain":
      "The domain of the current URL is not authorized for OAuth operations.",
